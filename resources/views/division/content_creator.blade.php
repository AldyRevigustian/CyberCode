            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last mb-3">
                        <h3>Content Creator Division</h3>
                    </div>
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table" id="table1">
                            ...
                            <tbody>
                                @foreach ($content_creators as $key => $cc)
                                    <tr>
                                        <td>{{ $key + 1 }}</td>
                                        <td><img src={{ asset('storage/image/photo_member/' . $cc->photo) }} alt=""
                                        ...
                                        <td>
                                            <a href="#" class="btn icon btn-success" data-bs-toggle="modal"
                                                data-bs-target="#modalEdit{{ $cc->id }}"><i
                                                    class="bi bi-pencil-fill"></i></a>

                                            <form action="{{ route('delete.member', $cc->id) }}" class="d-inline"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
